...
export default function Footer() {
  return (
    ...
    <footer className="relative z-[60] isolate w-full bg-[hsl(220,70%,3.9%)] text-stone-50 mt-0">
      ...
      <div className="w-full px-6 md:px-10 xl:px-28 pt-20 pb-10 inline-flex flex-col items-center gap-8">
        {/* bloque superior */}
        <div className="w-full flex flex-col gap-8">
          ...
          <div className="w-full flex flex-col xl:flex-row justify-between items-start gap-10">
            ...
            <div className="w-full xl:max-w-[847px] flex flex-col sm:flex-row justify-between items-start gap-10 min-[1384px]:gap-6 min-[1440px]:gap-6">
              {/* col 1: Showcase */}
            ...
            <div className="w-full xl:w-auto inline-flex flex-col justify-between items-center gap-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-md px-6 py-1.5 text-sm font-medium text-white shadow-lg bg-gradient-to-r from-sky-600 to-fuchsia-600 hover:opacity-90 transition text-center leading-none"
              >
              ...
              <div className="inline-flex items-center gap-3">
                <div className="flex items-center pr-3">
                  <Image src="/nocountry-logo.png" alt="No Country" width={143} height={24} className="h-6 min-[1384px]:w-auto min-[1384px]:h-auto w-auto shrink-0" />
                </div>
          ...
          {/* copyright */}
          <div className="w-full text-sm font-normal font-['DM_Sans'] leading-none">
