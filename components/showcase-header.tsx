...
export function ShowcaseHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-gradient-to-b from-background/70 via-background/30 to-transparent">
      ...
      {/* CONTENIDO con anchos/paddings por breakpoint */}
<div
  className="
...
<Link href="/" className="flex items-center gap-2">
  ...
  aria-label="Discord"
  title="Discord"
  className="inline-flex items-center gap-2 text-[18px] font-medium text-white/80 hover:text-white transition-colors"
>
  <span>Discord</span>
  <svg
    viewBox="0 0 24 24"
