      ...
      <div className="container relative z-10 flex h-16 md:h-20 items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-2">
            <img src="/nocountry-logo.png" alt="NoCountry Logo" className="h-8 md:h-9" />
          </Link>
        </div>

        <div className="hidden md:flex items-center gap-4" />

        <button className="md:hidden relative z-10" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label="Abrir menú">
          {isMenuOpen ? <X /> : <Menu />}
        </button>
      </div>
